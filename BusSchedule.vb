Public Class BusSchedule
    ...
    Private Sub btnViewRoute_Click(sender As Object, e As EventArgs) Handles btnViewRoute.Click
        ViewRouteInfo.Show()
    End Sub

    Private Sub btnViewBus_Click(sender As Object, e As EventArgs) Handles btnViewBus.Click
        ViewBusInfo.Show()
    End Sub

    Private Sub btnViewDriver_Click(sender As Object, e As EventArgs) Handles btnViewDriver.Click
        ViewStaffInfo.Show()
    End Sub
